...
local t = Def.ActorFrame {
	...
	InitCommand=function(self)
		...
		self.wheel_options = {
			...
			{ {"MixTape", "Preferred"}, AddFavorites },
			{ {"ChangeMode", "Casual"}, function() return not PremiumFreeActive() and SL.Global.Stages.PlayedThisGame == 0 and SL.Global.GameMode ~= "Casual" and ThemePrefs.Get("AllowScreenSelectPlayMode") end },
