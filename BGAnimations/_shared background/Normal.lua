...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and style ~= "SRPG9" and style ~= "Technique" and style ~= "ITG" and style ~= "Eurocup" and style ~= "KING")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or style == "SRPG9" or style == "Technique" or style == "ITG" or style == "Eurocup" or style == "KING" then
